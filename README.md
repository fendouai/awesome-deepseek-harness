...
- [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) ⭐6 — Login gateway (password door) for the DSH web UI: first-run setup, multi-user accounts, bcrypt + at-rest encryption, brute-force lockout, audit log, and automatic HTTPS with 80-to-443 redirect. (✅ active)
