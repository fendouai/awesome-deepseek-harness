...
description: "Model-driven context compression (Active Context Pruning): the model decides when and what to compress."
keywords: "billion-context-dsh, memory, plugin, context, deepseek harness, dsh"
---
# billion-context-dsh

> ⭐ **33** · ✅ active · plugin · ⬆️ +2 recently

| | | | |
|---|---|---|---|
| Type | plugin | Category | Memory & context |
| Stars | ⭐ 33 | Status | ✅ active |
| Author | [Tyan66666](https://github.com/Tyan66666) | Updated | 2026-08-21 |
| Subcategory | 📦 Context management | Capabilities | context, memory |

## One-liner

> Model-driven context compression (Active Context Pruning): the model decides when and what to compress.
...
- [Full README](https://github.com/Tyan66666/billion-context-dsh#readme)
