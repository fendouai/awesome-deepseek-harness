...
> ⭐ **60** · ✅ active · plugin · ⬆️ +1 recently

| | | | |
|---|---|---|---|
| Type | plugin | Category | Search & research |
| Stars | ⭐ 60 | Status | ✅ active |
| Author | [eri64](https://github.com/eri64) | Updated | 2026-08-15 |
...
- [GitHub Repository](https://github.com/eri64/dsh-claude-ux)
- [Full README](https://github.com/eri64/dsh-claude-ux#readme)
