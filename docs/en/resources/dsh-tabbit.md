...
> ⭐ **96** · ✅ active · integration

| | | | |
|---|---|---|---|
| Type | integration | Category | Browser control |
| Stars | ⭐ 96 | Status | ✅ active |
| Author | [Tabbit-Browser](https://github.com/Tabbit-Browser) | Updated | — |
...
- [GitHub Repository](https://github.com/Tabbit-Browser/dsh-tabbit)
- [Full README](https://github.com/Tabbit-Browser/dsh-tabbit#readme)
