...
description: "Run @deepseek-ai/dsh on Android/Termux."
keywords: "deepseek-harness-termux, mobile, client, terminal, deepseek harness, dsh"
---
# deepseek-harness-termux

> ⭐ **37** · ✅ active · client · ⬆️ +2 recently

| | | | |
|---|---|---|---|
| Type | client | Category | Mobile |
| Stars | ⭐ 37 | Status | ✅ active |
| Author | [Vengisk](https://github.com/Vengisk) | Updated | 2026-08-19 |

## One-liner

> Run @deepseek-ai/dsh on Android/Termux.
...
- [GitHub Repository](https://github.com/Vengisk/deepseek-harness-termux)
- [Full README](https://github.com/Vengisk/deepseek-harness-termux#readme)
