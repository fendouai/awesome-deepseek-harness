...
> ⭐ **33** · ✅ active · client · ⬆️ +3 recently

| | | | |
|---|---|---|---|
| Type | client | Category | Desktop |
| Stars | ⭐ 33 | Status | ✅ active |
| Author | [feiyang-dev](https://github.com/feiyang-dev) | Updated | 2026-08-20 |
...
- [Full README](https://github.com/feiyang-dev/dsh-usage-plugin#readme)
