---
title: "plugin-template (omdsh-dev)"
description: "Plugin template repository derived from the original turtle-ui official repo."
keywords: "plugin-template (omdsh-dev), learning, example, coding, deepseek harness, dsh"
---
