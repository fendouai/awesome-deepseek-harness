...
|---|---|---|---|---|
| 1 | [deepseek-harness-handbook](resources/deepseek-harness-handbook.md) | ⬆️ +43 | ⭐79 | Independent, source-backed, English-canonical and multilingual handbook for DeepSeek Harness: agent runtime, plugins, MCP, sandboxing, sessions, evaluation, and troubleshooting runbooks. |
| 2 | [dsh-handbook](resources/dsh-handbook.md) | ⬆️ +39 | ⭐604 | From 0 to 1 handbook: installation, plugin development, performance tuning, real-world cases and same-model multi-agent comparisons (CN + EN PDF). |
| 3 | [DeepSeek Harness Orange Book](resources/deepseek-harness-orange-book.md) | ⬆️ +24 | ⭐1,118 | Community Orange Book: complete system prompts, a 129-line startup checklist and three raw session logs — first-hand testing the official docs lack. Free PDF/EPUB/HTML. |
| 4 | [dshfind](resources/dshfind.md) | ⬆️ +10 | ⭐200 | Learn DSH principles, plugin marketplace and best practices — from chapter-by-chapter Cordis paper reading to an auto-aggregated plugin market. |
...
|---|---|---|---|---|
| 1 | [DeepSeek Harness Orange Book](resources/deepseek-harness-orange-book.md) | ⭐1,118 | Community Orange Book: complete system prompts, a 129-line startup checklist and three raw session logs — first-hand testing the official docs lack. Free PDF/EPUB/HTML. | ✅ active |
...
| 5 | [deepseek-harness-handbook](resources/deepseek-harness-handbook.md) | ⭐79 | Independent, source-backed, English-canonical and multilingual handbook for DeepSeek Harness: agent runtime, plugins, MCP, sandboxing, sessions, evaluation, and troubleshooting runbooks. | ✅ active |
...
| Project | Stars | Description | Status |
|---|---|---|---|
| [DeepSeek Harness Orange Book](resources/deepseek-harness-orange-book.md) | ⭐1,118 | Community Orange Book: complete system prompts, a 129-line startup checklist and three raw session logs — first-hand testing the official docs lack. Free PDF/EPUB/HTML. | ✅ active |
...
| [deepseek-harness-handbook](resources/deepseek-harness-handbook.md) | ⭐79 | Independent, source-backed, English-canonical and multilingual handbook for DeepSeek Harness: agent runtime, plugins, MCP, sandboxing, sessions, evaluation, and troubleshooting runbooks. | ✅ active |
...
| [deepseek-harness-learning](resources/deepseek-harness-learning.md) | ⭐7 | Learning website built from a systematic breakdown of the deepseek-harness repository, for developers curious how AI agent frameworks work. | ✅ active |
| [deepseek-harness-prompts](resources/deepseek-harness-prompts.md) | ⭐6 | DeepSeek Harness prompts for different modes. | ✅ active |
| [dsh-book-deepseek-harness](resources/dsh-book-deepseek-harness.md) | ⭐6 | 'Deep Dive into DeepSeek Harness' — source-level architecture book: 37 chapter files, PDF, Mermaid diagrams and writing conventions. | ✅ active |
