---
title: "deepseek-harness-desktop (Anywhere Labs)"
description: "为 DeepSeek Harness 生态打造的现代化桌面端体验（插件）。"
keywords: "deepseek-harness-desktop (Anywhere Labs), desktop, client, ui, deepseek harness, dsh"
---
...
- [完整 README](https://github.com/anywhere-labs/deepseek-harness-desktop#readme)
- [返回deepseek-harness-desktop (Anywhere Labs)所在分类](../clients.md)
