...
| 类型 | 精选列表 | 分类 | 注册表 |
| 星数 | ⭐ 145 | 状态 | ✅ 活跃 |
| 作者 | [imsai-sh](https://github.com/imsai-sh) | 更新时间 | 2026-08-21 |
...
- [GitHub 仓库](https://github.com/imsai-sh/awesome-deepseek-harness-plugins)
- [完整 README](https://github.com/imsai-sh/awesome-deepseek-harness-plugins#readme)
