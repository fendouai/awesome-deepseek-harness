...
| 类型 | 精选列表 | 分类 | 注册表 |
| 星数 | ⭐ 6 | 状态 | ✅ 活跃 |
| 作者 | [cccakeee](https://github.com/cccakeee) | 更新时间 | 2026-08-20 |
...
- [GitHub 仓库](https://github.com/cccakeee/awesome-dsh-plugins)
- [完整 README](https://github.com/cccakeee/awesome-dsh-plugins#readme)
- [返回awesome-dsh-plugins所在分类](../awesome-lists.md)
