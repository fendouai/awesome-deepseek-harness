...
| 类型 | 插件 | 分类 | 视觉与多模态 |
| 星数 | ⭐ 17 | 状态 | ✅ 活跃 |
| 作者 | [AlliotTech](https://github.com/AlliotTech) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/AlliotTech/deepseek-harness-docker)
- [完整 README](https://github.com/AlliotTech/deepseek-harness-docker#readme)
- [返回deepseek-harness-docker所在分类](../plugins.md)
