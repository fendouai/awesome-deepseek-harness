...
| 类型 | 客户端 | 分类 | 桌面端 |
| 星数 | ⭐ 426 | 状态 | ✅ 活跃 |
| 作者 | [fufankeji](https://github.com/fufankeji) | 更新时间 | 2026-08-21 |
...
- [GitHub 仓库](https://github.com/fufankeji/deepseek-harness-studio)
- [完整 README](https://github.com/fufankeji/deepseek-harness-studio#readme)
- [返回deepseek-harness-studio所在分类](../clients.md)
