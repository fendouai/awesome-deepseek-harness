...
| 类型 | 插件 | 分类 | 记忆与上下文 |
| 星数 | ⭐ 4 | 状态 | ✅ 活跃 |
| 作者 | [dsh-plugins](https://github.com/dsh-plugins) | 更新时间 | 2026-08-21 |
| 子分类 | 📦 上下文管理 | 能力 | coding, context, multimodal |
...
- [GitHub 仓库](https://github.com/dsh-plugins/dsh-auxiliary)
- [完整 README](https://github.com/dsh-plugins/dsh-auxiliary#readme)
- [返回dsh-auxiliary所在分类](../plugins.md)
