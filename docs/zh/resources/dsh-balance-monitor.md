...
| 类型 | 插件 | 分类 | 界面与体验 |
| 星数 | ⭐ 10 | 状态 | ✅ 活跃 |
| 作者 | [jelly-000](https://github.com/jelly-000) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/jelly-000/dsh-balance-monitor)
- [完整 README](https://github.com/jelly-000/dsh-balance-monitor#readme)
- [返回dsh-balance-monitor所在分类](../plugins.md)
