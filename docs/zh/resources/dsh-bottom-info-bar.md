...
| 类型 | 集成 | 分类 | 渠道 |
| 星数 | ⭐ 26 | 状态 | ✅ 活跃 |
| 作者 | [songoao25](https://github.com/songoao25) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/songoao25/dsh-bottom-info-bar)
- [完整 README](https://github.com/songoao25/dsh-bottom-info-bar#readme)
- [返回dsh-bottom-info-bar所在分类](../integrations.md)
