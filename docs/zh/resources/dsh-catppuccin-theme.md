...
| 类型 | 插件 | 分类 | 搜索与研究 |
| 星数 | ⭐ 22 | 状态 | ✅ 活跃 |
| 作者 | [NoNameLeGo](https://github.com/NoNameLeGo) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/NoNameLeGo/dsh-catppuccin-theme)
- [完整 README](https://github.com/NoNameLeGo/dsh-catppuccin-theme#readme)
- [返回dsh-catppuccin-theme所在分类](../plugins.md)
