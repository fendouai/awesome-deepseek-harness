...
| 类型 | 插件 | 分类 | 视觉与多模态 |
| 星数 | ⭐ 3 | 状态 | ✅ 活跃 |
| 作者 | [CN-Leo](https://github.com/CN-Leo) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/CN-Leo/dsh-deepseek-balance)
- [完整 README](https://github.com/CN-Leo/dsh-deepseek-balance#readme)
