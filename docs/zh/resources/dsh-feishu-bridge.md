...
| 类型 | 集成 | 分类 | 渠道 |
| 星数 | ⭐ 5 | 状态 | ✅ 活跃 |
| 作者 | [wz-heng](https://github.com/wz-heng) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/wz-heng/dsh-feishu-bridge)
- [完整 README](https://github.com/wz-heng/dsh-feishu-bridge#readme)
- [返回dsh-feishu-bridge所在分类](../integrations.md)
