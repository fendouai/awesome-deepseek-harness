...
| 类型 | 插件 | 分类 | 视觉与多模态 |
| 星数 | ⭐ 28 | 状态 | ✅ 活跃 |
| 作者 | [taxueseek](https://github.com/taxueseek) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/taxueseek/dsh-files)
- [完整 README](https://github.com/taxueseek/dsh-files#readme)
- [返回dsh-files所在分类](../plugins.md)
