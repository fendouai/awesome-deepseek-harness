...
| 类型 | 插件 | 分类 | 搜索与研究 |
| 星数 | ⭐ 38 | 状态 | ✅ 活跃 |
| 作者 | [DDDMUC](https://github.com/DDDMUC) | 更新时间 | 2026-08-20 |
...
- [GitHub 仓库](https://github.com/DDDMUC/dsh-free-search)
- [完整 README](https://github.com/DDDMUC/dsh-free-search#readme)
- [返回dsh-free-search所在分类](../plugins.md)
