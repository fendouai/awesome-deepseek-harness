...
description: "Godot Engine 4.x 全栈游戏开发技能插件。"
...
| 类型 | 技能 | 分类 | 编码 |
| 星数 | ⭐ 9 | 状态 | ✅ 活跃 |
| 作者 | [akira399](https://github.com/akira399) | 更新时间 | 2026-08-13 |

## 一句话介绍

> Godot Engine 4.x 全栈游戏开发技能插件。
...
- [GitHub 仓库](https://github.com/akira399/dsh-godot-skill)
- [完整 README](https://github.com/akira399/dsh-godot-skill#readme)
- [返回dsh-godot-skill所在分类](../skills.md)
