---
title: "dsh-gomoku"
description: "在 DSH 中与 AI 下五子棋，也可以让 AI 对局比试模型强弱。"
...
| 类型 | 插件 | 分类 | 娱乐与生活 |
| 星数 | ⭐ 14 | 状态 | ✅ 活跃 |
| 作者 | [omdsh-dev](https://github.com/omdsh-dev) | 更新时间 | 2026-08-15 |

## 一句话介绍

> 在 DSH 中与 AI 下五子棋，也可以让 AI 对局比试模型强弱。
...
- [GitHub 仓库](https://github.com/omdsh-dev/dsh-gomoku)
- [完整 README](https://github.com/omdsh-dev/dsh-gomoku#readme)
- [返回dsh-gomoku所在分类](../plugins.md)
