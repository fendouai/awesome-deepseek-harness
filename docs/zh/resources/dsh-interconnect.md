...
description: "跨实例消息/事件交接插件（interconnect 服务 + 工具）。"
...
| 类型 | 智能体 | 分类 | 多智能体 |
| 星数 | ⭐ 34 | 状态 | ✅ 活跃 |
| 作者 | [Chinesezjc](https://github.com/Chinesezjc) | 更新时间 | 2026-08-19 |

## 一句话介绍

> 跨实例消息/事件交接插件（interconnect 服务 + 工具）。
...
- [GitHub 仓库](https://github.com/Chinesezjc/dsh-interconnect)
- [完整 README](https://github.com/Chinesezjc/dsh-interconnect#readme)
- [返回dsh-interconnect所在分类](../agents.md)
