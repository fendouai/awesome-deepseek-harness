...
| 类型 | 插件 | 分类 | 视觉与多模态 |
| 星数 | ⭐ 4 | 状态 | ✅ 活跃 |
| 作者 | [Favio8](https://github.com/Favio8) | 更新时间 | 2026-08-17 |
| 子分类 | 👁️ 视觉工具 | 能力 | coding, multimodal, ui |
...
- [GitHub 仓库](https://github.com/Favio8/dsh-plugin-deepeye)
- [完整 README](https://github.com/Favio8/dsh-plugin-deepeye#readme)
- [返回dsh-plugin-deepeye所在分类](../plugins.md)
