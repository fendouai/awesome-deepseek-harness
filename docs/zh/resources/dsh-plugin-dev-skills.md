...
| 类型 | 客户端 | 分类 | 桌面端 |
| 星数 | ⭐ 38 | 状态 | ✅ 活跃 |
| 作者 | [zimodzh](https://github.com/zimodzh) | 更新时间 | 2026-08-18 |
...
- [GitHub 仓库](https://github.com/zimodzh/dsh-plugin-dev-skills)
- [完整 README](https://github.com/zimodzh/dsh-plugin-dev-skills#readme)
- [返回dsh-plugin-dev-skills所在分类](../clients.md)
