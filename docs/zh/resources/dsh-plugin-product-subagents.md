...
description: "基于角色的 Codex/Claude Code/ACP 子代理提供方：可延续的子任务，带持久状态。"
...
| 类型 | 智能体 | 分类 | 多智能体 |
| 星数 | ⭐ 17 | 状态 | ✅ 活跃 |
| 作者 | [shaokeyibb](https://github.com/shaokeyibb) | 更新时间 | 2026-08-17 |

## 一句话介绍

> 基于角色的 Codex/Claude Code/ACP 子代理提供方：可延续的子任务，带持久状态。
...
- [GitHub 仓库](https://github.com/shaokeyibb/dsh-plugin-product-subagents)
- [完整 README](https://github.com/shaokeyibb/dsh-plugin-product-subagents#readme)
- [返回dsh-plugin-product-subagents所在分类](../agents.md)
