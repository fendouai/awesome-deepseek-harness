...
| 类型 | 插件 | 分类 | 视觉与多模态 |
| 星数 | ⭐ 1 | 状态 | ✅ 活跃 |
| 作者 | [MoneShadow](https://github.com/MoneShadow) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/MoneShadow/dsh-plugin-vision)
- [完整 README](https://github.com/MoneShadow/dsh-plugin-vision#readme)
- [返回dsh-plugin-vision所在分类](../plugins.md)
