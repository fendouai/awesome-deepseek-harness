...
| 类型 | 插件 | 分类 | 搜索与研究 |
| 星数 | ⭐ 3 | 状态 | ✅ 活跃 |
| 作者 | [Wine-Red](https://github.com/Wine-Red) | 更新时间 | 2026-08-19 |
| 子分类 | 🌐 网页搜索 | 能力 | coding |
...
- [GitHub 仓库](https://github.com/Wine-Red/dsh-prompt-stash)
- [完整 README](https://github.com/Wine-Red/dsh-prompt-stash#readme)
- [返回dsh-prompt-stash所在分类](../plugins.md)
