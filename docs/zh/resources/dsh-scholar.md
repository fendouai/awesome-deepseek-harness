...
| 类型 | 插件 | 分类 | 开发者工具 |
| 星数 | ⭐ 25 | 状态 | ✅ 活跃 |
| 作者 | [lzszq](https://github.com/lzszq) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/lzszq/dsh-scholar)
- [完整 README](https://github.com/lzszq/dsh-scholar#readme)
- [返回dsh-scholar所在分类](../plugins.md)
