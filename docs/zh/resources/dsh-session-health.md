...
description: "多帧 zstd 会话文件的帧级扫描诊断：撕裂/损坏/空会话检测，零依赖只读。"
...
| 子分类 | 🔍 上下文审计 | 能力 | observability, files |

## 一句话介绍

> 多帧 zstd 会话文件的帧级扫描诊断：撕裂/损坏/空会话检测，零依赖只读。
...
- [GitHub 仓库](https://github.com/omdsh-dev/dsh-session-health)
- [完整 README](https://github.com/omdsh-dev/dsh-session-health#readme)
- [返回dsh-session-health所在分类](../plugins.md)
