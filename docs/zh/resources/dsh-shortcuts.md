...
| 类型 | 插件 | 分类 | 搜索与研究 |
| 星数 | ⭐ 3 | 状态 | ✅ 活跃 |
| 作者 | [Ricketts-Guo](https://github.com/Ricketts-Guo) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/Ricketts-Guo/dsh-shortcuts)
- [完整 README](https://github.com/Ricketts-Guo/dsh-shortcuts#readme)
- [返回dsh-shortcuts所在分类](../plugins.md)
