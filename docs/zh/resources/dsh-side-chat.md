...
| 类型 | 插件 | 分类 | 开发者工具 |
| 星数 | ⭐ 12 | 状态 | ✅ 活跃 |
| 作者 | [heartmove](https://github.com/heartmove) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/heartmove/dsh-side-chat)
- [完整 README](https://github.com/heartmove/dsh-side-chat#readme)
- [返回dsh-side-chat所在分类](../plugins.md)
