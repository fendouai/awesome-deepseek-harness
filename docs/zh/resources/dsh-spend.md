---
title: "dsh-spend"
description: "Token 用量与费用估算：悬浮面板，按模型/天/会话统计，自动识别计费套餐。"
...
| 类型 | 插件 | 分类 | 界面与体验 |
| 星数 | ⭐ 7 | 状态 | ✅ 活跃 |
| 作者 | [nonewind](https://github.com/nonewind) | 更新时间 | 2026-08-18 |
| 子分类 | 🖥️ 侧边栏与面板 | 能力 | observability, ui |

## 一句话介绍

> Token 用量与费用估算：悬浮面板，按模型/天/会话统计，自动识别计费套餐。
...
- [GitHub 仓库](https://github.com/nonewind/dsh-spend)
- [完整 README](https://github.com/nonewind/dsh-spend#readme)
- [返回dsh-spend所在分类](../plugins.md)
