...
| 类型 | 插件 | 分类 | 搜索与研究 |
| 星数 | ⭐ 9 | 状态 | ✅ 活跃 |
| 作者 | [dsh-ssh](https://github.com/dsh-ssh) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/dsh-ssh/dsh-ssh)
- [完整 README](https://github.com/dsh-ssh/dsh-ssh#readme)
- [返回dsh-ssh所在分类](../plugins.md)
