...
| 类型 | 插件 | 分类 | 搜索与研究 |
| 星数 | ⭐ 68 | 状态 | ✅ 活跃 |
| 作者 | [Awu12277](https://github.com/Awu12277) | 更新时间 | — |
| 子分类 | 🌐 网页搜索 | 能力 | coding |
...
- [GitHub 仓库](https://github.com/Awu12277/dsh-stock-watch)
- [完整 README](https://github.com/Awu12277/dsh-stock-watch#readme)
- [返回dsh-stock-watch所在分类](../plugins.md)
