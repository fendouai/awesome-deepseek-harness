...
| 类型 | 插件 | 分类 | 界面与体验 |
| 星数 | ⭐ 7 | 状态 | ✅ 活跃 |
| 作者 | [juhe291](https://github.com/juhe291) | 更新时间 | 2026-08-17 |
...
- [GitHub 仓库](https://github.com/juhe291/dsh-token-panel)
- [完整 README](https://github.com/juhe291/dsh-token-panel#readme)
- [返回dsh-token-panel所在分类](../plugins.md)
