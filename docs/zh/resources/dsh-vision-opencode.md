...
| 类型 | 插件 | 分类 | 视觉与多模态 |
| 星数 | ⭐ 13 | 状态 | ✅ 活跃 |
| 作者 | [poiuyjie](https://github.com/poiuyjie) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/poiuyjie/dsh-vision-opencode)
- [完整 README](https://github.com/poiuyjie/dsh-vision-opencode#readme)
- [返回dsh-vision-opencode所在分类](../plugins.md)
