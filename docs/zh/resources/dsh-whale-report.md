...
| 类型 | 插件 | 分类 | 界面与体验 |
| 星数 | ⭐ 31 | 状态 | ✅ 活跃 |
| 作者 | [SenmuuuuW](https://github.com/SenmuuuuW) | 更新时间 | — |
...
- [GitHub 仓库](https://github.com/SenmuuuuW/dsh-whale-report)
- [完整 README](https://github.com/SenmuuuuW/dsh-whale-report#readme)
- [返回dsh-whale-report所在分类](../plugins.md)
