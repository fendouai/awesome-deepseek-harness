...
| 类型 | 客户端 | 分类 | 桌面端 |
| 星数 | ⭐ 138 | 状态 | ✅ 活跃 |
| 作者 | [salathleizhang](https://github.com/salathleizhang) | 更新时间 | 2026-08-19 |
...
- [GitHub 仓库](https://github.com/salathleizhang/deepseek-harness-desktop)
- [完整 README](https://github.com/salathleizhang/deepseek-harness-desktop#readme)
- [返回deepseek-harness-desktop (salathleizhang)所在分类](../clients.md)
